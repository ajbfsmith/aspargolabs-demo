...
/** Source-of-truth seed data used to populate Sanity and as a local fallback. */
export const seedBlogPosts: BlogPost[] = [
  {
    slug: "oral-spray-vs-tablets-pharmacokinetics",
    title: "Why an Oral Spray Absorbs Faster Than a Tablet",
    excerpt:
      "Traditional ED tablets must survive gastric acid, pass through the liver, and compete with food. Oral spray suspension bypasses all three bottlenecks.",
    date: "2026-05-28",
    readTime: "6 min read",
    tag: "Science",
...
Despite the faster onset, total drug exposure (AUC) remains bioequivalent to the reference tablet, meaning you get the same therapeutic effect, just delivered more efficiently.
  ...
  },
  {
    ...
    excerpt:
      "The 45-minute wait for a pill to kick in creates a secondary anxiety loop. Research shows that reducing onset time has outsized psychological benefits.",
    date: "2026-05-14",
    readTime: "5 min read",
    tag: "Wellness",
...
Studies consistently show that medication adherence improves when the treatment feels less like a clinical intervention. By removing friction, both temporal and psychological, spray suspension technology may improve not just onset, but overall treatment success rates.
  ...
  },
  {
    ...
    excerpt:
      "Every pump of HEZKUE® delivers a calibrated dose. Learn why titration flexibility matters more than most patients realise.",
    date: "2026-04-30",
    readTime: "4 min read",
    tag: "Product",
...
Accelerate Health's platform is not limited to sildenafil. The same spray suspension technology can be adapted to deliver a range of APIs, from analgesics to anxiolytics, wherever rapid buccal absorption offers a clinical advantage over traditional oral dosage forms.
  ...
  },
  {
    ...
    excerpt:
      "Oral tablets have dominated pharmacology for over a century. A new generation of delivery systems is rewriting the rules.",
    date: "2026-03-22",
    readTime: "8 min read",
    tag: "Industry",
