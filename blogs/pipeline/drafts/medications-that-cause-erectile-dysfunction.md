...
expanded_at: '2026-06-19T22:56:06.505857+00:00'
focusKeyword: 25 common medications that
generated_at: '2026-06-19T14:42:42.377044+00:00'
grounding_sources: []
inline_links:
- label: Harvard Health
  url: https://www.health.harvard.edu/mens-health/medications-that-can-cause-erectile-dysfunction
- label: Mayo Clinic
  url: https://www.mayoclinic.org/diseases-conditions/depression/in-depth/ssris/art-20044825
- label: Journal of Sexual Medicine
  url: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3483715/
- label: Endocrine Society
  url: https://www.endocrine.org/patient-engagement/endocrine-library/opioids-and-hormones
- label: every ed treatment available
  url: /blog/ed-treatment-options-2026
- label: eat avoid before taking
  url: /blog/ed-medication-food-alcohol-interactions
- label: Explore HEZKUE
  url: /checkout
- label: 'Cleveland Clinic: Erectile Dysfunction (ED): Causes, Symptoms & Treatment'
...
status: draft
tier: 1
title: 25 Common Medications That Can Cause Erectile Dysfunction (and What to Do About
  It)
word_count: 2454
---
...
Often called "water pills," thiazides help the body shed excess salt and water. While effective for blood pressure, they are among the most common medications linked to ED. According to [Harvard Health](https://www.health.harvard.edu/mens-health/medications-that-can-cause-erectile-dysfunction), diuretics can reduce the force of blood flow into the penis. 
...
Dopamine is the "reward" chemical that drives sexual desire. When serotonin is artificially high, it can dampen the physical response to sexual stimuli. [Mayo Clinic](https://www.mayoclinic.org/diseases-conditions/depression/in-depth/ssris/art-20044825) notes that sexual side effects are reported by a significant percentage of patients on SSRIs, with Paroxetine often cited as having the highest incidence of these effects.
...
Some men report persistent sexual side effects even after stopping these medications, a phenomenon often referred to as "Post-Finasteride Syndrome" (PFS). Research published in the [Journal of Sexual Medicine](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3483715/) suggests that while these side effects are relatively rare, they can be significant for those affected, impacting both erection quality and libido.
...
This often results in low libido, ED, and even muscle loss. The [Endocrine Society](https://www.endocrine.org/patient-engagement/endocrine-library/opioids-and-hormones) highlights that managing chronic pain requires a careful balance to avoid these systemic hormonal impacts. Methadone, in particular, is frequently associated with high rates of sexual dysfunction in men undergoing addiction treatment.
...
1.  **Consult Your Prescriber:** Schedule a dedicated appointment to discuss side effects. Doctors are accustomed to these conversations and can often adjust your dosage or switch you to a medication with a lower profile for sexual side effects.
2.  **Explore Alternatives:** For example, if a beta-blocker is causing issues, an ACE inhibitor or ARB (Angiotensin II Receptor Blocker) may be an alternative that is less likely to cause ED.
3.  **Consider Timing:** In some cases, adjusting the time of day you take your medication can minimize its impact on your sexual life. Taking a dose after sexual activity rather than before may help.
4.  **Review Lifestyle Factors:** Sometimes, ED is a combination of medication side effects and lifestyle factors. Reviewing [every ed treatment available](/blog/ed-treatment-options-2026) can help you identify other areas for improvement, such as diet and exercise.
5.  **Understand Interactions:** If you are prescribed an ED medication, it is crucial to understand how it interacts with your current regimen. Be sure to read about what to [eat avoid before taking](/blog/ed-medication-food-alcohol-interactions) medication to ensure maximum efficacy and safety.
...
- [Harvard Health: Medications that can cause erectile dysfunction](https://www.health.harvard.edu/mens-health/medications-that-can-cause-erectile-dysfunction)
- [Mayo Clinic: Antidepressants: Which cause the fewest sexual side effects?](https://www.mayoclinic.org/diseases-conditions/depression/in-depth/ssris/art-20044825)
- [National Institutes of Health (PMC): Persistent Sexual Side Effects of 5α-Reductase Inhibitors](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3483715/)
- [Cleveland Clinic: Erectile Dysfunction (ED): Causes, Symptoms & Treatment](https://my.clevelandclinic.org/health/diseases/9121-erectile-dysfunction)
- [Endocrine Society: Opioids and Hormones](https://www.endocrine.org/patient-engagement/endocrine-library/opioids-and-hormones)
- [American Heart Association: High Blood Pressure and Sexual Health](https://www.heart.org/en/health-topics/high-blood-pressure/changes-you-can-make-to-manage-high-blood-pressure/types-of-blood-pressure-medications)
- [Journal of Clinical Psychiatry: Prevalence of Sexual Dysfunction in Patients Treated with SSRIs](https://pubmed.ncbi.nlm.nih.gov/10775140/)
